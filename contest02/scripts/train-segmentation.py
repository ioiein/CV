...
def main(args):
    ...
    train_dataset = DetectionDataset(args.data_path, os.path.join("./", "train_segmentation.json"),
    ...
    val_dataset = DetectionDataset(args.data_path, os.path.join("./", "train_segmentation.json"),
